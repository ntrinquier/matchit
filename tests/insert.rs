...
fn prefix_suffix_conflict() {
    InsertTest(vec![
        ...
        (
            "/x12/prefix{a}suffix",
            Err(conflict("/x12/prefix{a}suffix")),
        ),
        (
            "/x12/prefixabc{a}suffix",
            Err(conflict("/x12/prefix{a}suffix")),
        ),
        ...
        (
            "/x13/prefix{a}suffix",
            Err(conflict("/x13/prefix{a}suffix")),
        ),
        (
            "/x13/prefixabc{a}suffix",
            Err(conflict("/x13/prefix{a}suffix")),
        ),
